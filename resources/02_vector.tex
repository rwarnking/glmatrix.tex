...
% Equation: \(\begin{pmatrix} v_1\\ ...\\ v_N \end{pmatrix}\)
...
% Equation: \(\begin{bmatrix}v_1, ..., v_N\end{bmatrix}\)
% Example: \textbackslash newVec\{myNewVec\}\{1, 2, 3\}
...
% Equation: \(D_1(v_1) * D_1(v_2) + ... + D_N(v_1) * D_N(v_2)\)
...
% Equation: \(#2 = \begin{pmatrix}\lfloor X(#3)\rceil\\\lfloor Y(#3)\rceil\\...\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVec\}\{0.5, 1, 2\}
% Example: \textbackslash roundVec\{\textbackslash myNewVec\}
% Example: \textbackslash out \(\xrightarrow{} \begin{pmatrix}1\\1\\2\end{pmatrix}\)
...
% Equation: \(#1 = \begin{pmatrix}\lceil X(#2)\rceil\\\lceil Y(#2)\rceil\\...\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVec\}\{0.5, 1, 2\}
...
% Equation: \(#1 = \begin{pmatrix}\lfloor X(#2)\rfloor\\\lfloor Y(#2)\rfloor\\...\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVec\}\{0.5, 1, 2\}
...
% Vector Math %
%%%%%%%%%%%%%%%
% Add the values of a n vectors from one vector. The list can have one or many entries.
% Equation: \(#1 = \begin{pmatrix}X(#2) + X(#3_1) + X(#3_2)\\Y(#2) + Y(#3_1) + Y(#3_2)\\...\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
% Example: \textbackslash newVec\{myNewVecB\}\{0.5, 1, 2\}
...
% Subract the values of a n vectors from one vector. The list can have one or many entries.
% Equation: \(#1 = \begin{pmatrix}X(#2) - X(#3_1) - X(#3_2)\\Y(#2) - Y(#3_1) - Y(#3_2)\\...\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
% Example: \textbackslash newVec\{myNewVecB\}\{0.5, 1, 2\}
...
% Multiply the values of a vector with these of a list of vectors. The list can have one or many entries.
% Equation: \(#1 = \begin{pmatrix}X(#2) * X(#3_1) * X(#3_2)\\Y(#2) * Y(#3_1) * Y(#3_2)\\...\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
% Example: \textbackslash newVec\{myNewVecB\}\{0.5, 1, 2\}
...
% Divide the values of a vector with these of a list of vectors. The list can have one or many entries.
% Equation: \(#1 = \begin{pmatrix}X(#2) / X(#3_1) / X(#3_2)\\Y(#2) / Y(#3_1) / Y(#3_2)\\...\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
% Example: \textbackslash newVec\{myNewVecB\}\{0.5, 1, 2\}
...
% Equation: \(#1 = \begin{pmatrix}X(#2) * scalar\\Y(#2)* scalar\\...\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
...
% Equation: \(#1 = \begin{pmatrix}\frac{X(#2)}{scalar}\\\frac{Y(#2)}{scalar}\\...\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
% Example: \textbackslash newScalar\{myNewScalar\}\{2\}
...
% Equation: \(#1 = \begin{pmatrix}-X(#2)\\-Y(#2)\\-...\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
...
% Equation: \(#1 = \begin{pmatrix} \min(X(v_1), X(v_2))\\ \min(Y(v_1), Y(v_2))\\ ... \end{pmatrix}\)
% Error: When vector 1 and 2 do not have the same length
% #1 out, var name to save the result (vector) to
% #2 vector 1, the first vector
% #3 vector 2, the second vector
...
% Equation: \(#1 = \begin{pmatrix} \max(X(v_1), X(v_2))\\ \max(Y(v_1), Y(v_2))\\ ... \end{pmatrix}\)
% Error: When vector 1 and 2 do not have the same length
% #1 out, var name to save the result (vector) to
% #2 vector 1, the first vector
% #3 vector 2, the second vector
