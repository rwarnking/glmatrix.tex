...
% Equation: \(\begin{pmatrix} v_1\\ \ldots\\ v_N \end{pmatrix}\)
...
% Equation: \(\begin{bmatrix}v_1\\ \ldots\\ v_N\end{bmatrix}\)
% Example: \textbackslash newVec\{myNewVec\}\{1, 2, 3\}
...
% Equation: \(\begin{pmatrix}\left\{\frac{X(#2)}{\pi})\right\}\\ \left\{\frac{Y(#2)}{\pi}\right\}\\ \ldots\end{pmatrix}\pi\)
% Example: \textbackslash newVec\{myNewVec\}\{0.5, 1, 2\}
...
% Equation: \(\trans{\left(\left\{\frac{X(#2)}{\pi}\right\}, \left\{\frac{Y(#2)}{\pi}\right\}, \ldots\right)}\pi\)
% Example: \textbackslash newVec\{myNewVec\}\{0.5, 1, 2\}
...
% Equation: \(D_1(v_1) * D_1(v_2) + \ldots + D_N(v_1) * D_N(v_2)\)
...
% Equation: \(\begin{pmatrix} Y(v_1)*Z(v_2) - Z(v_1)*Y(v_2)\\ Z(v_1)*X(v_2)-X(V_1)*Z(v_2)\\ X(v_1)*Y(v_2)-Y(v_2)*X(v_2) \end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
...
% Equation: \(#2 = \begin{pmatrix}\lfloor X(#3)\rceil\\\lfloor Y(#3)\rceil\\\ldots\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVec\}\{0.5, 1, 2\}
...
% Equation: \(#1 = \begin{pmatrix}\lceil X(#2)\rceil\\\lceil Y(#2)\rceil\\\ldots\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVec\}\{0.5, 1, 2\}
...
% Equation: \(#1 = \begin{pmatrix}\lfloor X(#2)\rfloor\\\lfloor Y(#2)\rfloor\\\ldots\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVec\}\{0.5, 1, 2\}
...
% Equation: \(#1 = \begin{pmatrix} x/w \\ y/w \\ z/w \end{pmatrix}\)
...
% Vector Math %
%%%%%%%%%%%%%%%
% Add the values of \(1\) to \(n\) vectors to the values of the given vector.
% Equation: \(#1 = \begin{pmatrix}X(#2) + X(#3_1) + X(#3_2)\\Y(#2) + Y(#3_1) + Y(#3_2)\\\ldots\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
% Example: \textbackslash newVec\{myNewVecB\}\{0.5, 1, 2\}
...
% Subract the values of \(1\) to \(n\) vectors from the values of the given vector.
% Equation: \(#1 = \begin{pmatrix}X(#2) - X(#3_1) - X(#3_2)\\Y(#2) - Y(#3_1) - Y(#3_2)\\\ldots\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
% Example: \textbackslash newVec\{myNewVecB\}\{0.5, 1, 2\}
...
% Multiply the values of \(1\) to \(n\) vectors with the values of the given vector.
% See Hadamard product (element-wise product) for more information.
% Equation: \begin{align*}#1 &= #2 \odot #3_1 (\odot #3_2 \ldots)\\ &= \begin{pmatrix}X(#2) * X(#3_1) * X(#3_2)\\Y(#2) * Y(#3_1) * Y(#3_2)\\\ldots\end{pmatrix}\end{align*}
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
% Example: \textbackslash newVec\{myNewVecB\}\{0.5, 1, 2\}
...
% Divide the values of the given vector by the values of \(1\) to \(n\) vectors (element-wise division).
% Equation: \begin{align*}#1 &= #2 \oslash #3_1 (\oslash #3_2 \ldots)\\ &= \begin{pmatrix}X(#2) / X(#3_1) / X(#3_2)\\Y(#2) / Y(#3_1) / Y(#3_2)\\\ldots\end{pmatrix}\end{align*}
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
% Example: \textbackslash newVec\{myNewVecB\}\{0.5, 1, 2\}
...
% Equation: \(#1 = \begin{pmatrix}X(#2) * scalar\\Y(#2)* scalar\\\ldots\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
...
% Equation: \(#1 = \begin{pmatrix}\frac{X(#2)}{scalar}\\\frac{Y(#2)}{scalar}\\\ldots\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
% Example: \textbackslash newScalar\{myNewScalar\}\{2\}
...
% Equation: \(#1 = \begin{pmatrix}-X(#2)\\-Y(#2)\\-\ldots\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
...
% #4 control 2, the second control point
...
% Equation: \(#1 = X(#2) * X(#3) + Y(#2) * Y(#3) + \ldots\)
% Error: When both vectors do not have the same length
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
% Example: \textbackslash newVec\{myNewVecB\}\{1, 2, 4\}
...
% Equation: \(#1 = \begin{pmatrix} \frac{X(#2)}{\norm{#2}}\\ \frac{Y(#2)}{\norm{#2}}\\ \ldots\end{pmatrix}\)
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
...
% Equation: \(#1 = \begin{pmatrix} ab*bc - ac*bb\\ ac*ba-aa*bc\\ aa*bb-ab*ba \end{pmatrix}\)
% Error: When one of both vectors does not have length 3
% Example: \textbackslash newVec\{myNewVecA\}\{0.5, 1, 2\}
...
% Equation: \(#1 = \begin{pmatrix} \min(X(v_1), X(v_2))\\ \min(Y(v_1), Y(v_2))\\ \ldots \end{pmatrix}\)
% Error: When vector 1 and 2 do not have the same length
% #1 out, var name to save the result (vector) to
% #2 vector 1, the first vector
% #3 vector 2, the second vector
...
% Equation: \(#1 = \begin{pmatrix} \max(X(v_1), X(v_2))\\ \max(Y(v_1), Y(v_2))\\ \ldots \end{pmatrix}\)
% Error: When vector 1 and 2 do not have the same length
% #1 out, var name to save the result (vector) to
% #2 vector 1, the first vector
% #3 vector 2, the second vector
