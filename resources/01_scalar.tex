...
% Example: \textbackslash myNewScalar \(\xrightarrow{}\) 3
...
% Create a new scalar that is a multiple of pi.
% Example: \textbackslash newScalarPi\{myNewScalar\}\{3\}
% Example: \textbackslash myNewScalar \(\xrightarrow{}\) 9.42
% #1 out, var name to save the result (scalar) to
...
% Example: \textbackslash myRandomScalar \(\xrightarrow{}\) 5
% #1 out, var name to save the result (scalar) to
...
% Example: \textbackslash myCopyScalar \(\xrightarrow{}\) 3
% #1 out, var name to save the result (scalar) to
...
% Example: \textbackslash myNewScalar \(\xrightarrow{}\) 4
% #1 out, var name to save the result (scalar) to
% #2 scalar, scalar value that is assigned to out
...
% Example: \textbackslash myZeroScalar \(\xrightarrow{}\) 0
% #1 out, var name to save the result (scalar) to
...
% Example: \textbackslash printScalar[1]\{\textbackslash myNewScalar\} \(\xrightarrow{} \frac{1}{2}\)
...
% Equation: \(\left\{\frac{scalar}{\pi}\right\}\pi\)
% Example: \textbackslash newScalarPi\{myNewScalar\}\{0.5\}
% Example: \textbackslash printScalarAsPi[1]\{\textbackslash myNewScalar\} \(\xrightarrow{} \frac{1}{2} \pi\)
% #1 fraction, whether or not the value should be printed as a fraction (val=1)
% #2 scalar, the scalar that should be printed
...
% Equation: \((scalar*180/\pi)^\circ\)
% Example: \textbackslash newScalarPi\{myNewScalar\}\{0.5\}
% Example: \textbackslash printPiScalarInDegree[1]\{\textbackslash myNewScalar\} \(\xrightarrow{} 90^\circ\)
% #1 fraction, whether or not the value should be printed as a fraction (val=1)
...
% Example: \textbackslash newScalar\{myNewScalar\}\{0.5\}
% Example: \textbackslash printScalarRounded\{\textbackslash myNewScalar\} \(\xrightarrow{} 1\)
...
% Example: \textbackslash myNewScalar \(\xrightarrow{} 1\)
% #1 digits, number of digits after comma
...
% Example: \textbackslash myNewScalar \(\xrightarrow{} 0\)
% #1 out, var name to save the result (scalar) to
...
% Example: \textbackslash myNewScalar \(\xrightarrow{} 5\)
% #1 out, var name to save the result (scalar) to
...
% Example: \textbackslash radianToDegreeResult \(\xrightarrow{} 90\)
...
% Example: \textbackslash degreeToRadianResult \(\xrightarrow{} 1.5707\)
% #1 out, var name to save the result (scalar) to
% #2 scalar, the scalar which to convert
...
% Example: \textbackslash scalarAddResult \(\xrightarrow{} 3\)
% #1 out, var name to save the result (scalar) to
% #2 scalar 1, the first scalar of the sum
% #3 scalar 2, the second scalar of the sum
...
% Example: \textbackslash scalarSubResult \(\xrightarrow{} -1\)
% #1 out, var name to save the result (scalar) to
% #2 scalar 1, the scalar to subtract from
% #3 scalar 2, the scalar to subtract
...
% Example: \textbackslash scalarMulResult \(\xrightarrow{} 6\)
% #1 out, var name to save the result (scalar) to
% #2 scalar 1, the scalar to multiply
% #3 scalar 2, the scalar with which to multply
...
% Equation: \(out = \frac{scalar1}{scalar2}\)
...
% Example: \textbackslash scalarDivResult \(\xrightarrow{} 2\)
% #1 out, var name to save the result (scalar) to
% #2 scalar 1, the scalar to divide
% #3 scalar 2, the scalar to divide with
...
% Example: \textbackslash scalarPowResult \(\xrightarrow{} 8\)
% #1 out, var name to save the result (scalar) to
% #2 scalar 1, the scalar to raise
% #3 scalar 2, the scalar with which to raise
...
% Example: \textbackslash scalarNegateResult \(\xrightarrow{} -2\)
% #1 out, var name to save the result (scalar) to
...
% Example: \textbackslash scalarMulAndAddResult \(\xrightarrow{} 11\)
% #1 out, var name to save the result (scalar) to
% #2 scalar 1, the scalar to add to
% #3 scalar 2, the scalar that is multiplied and then added
% #4 scalar 3, the scalar that is the muliplier
...
% Equation: \(out = (1-t) * scalar1 + t * scalar2\)
% Example: \textbackslash newScalar\{myNewScalarA\}\{2\}
% Example: \textbackslash newScalar\{myNewScalarB\}\{3\}
...
% Example: \textbackslash lerpScalarResult \(\xrightarrow{} 2.5\)
% #1 out, var name to save the result (scalar) to
% #2 scalar 1, the start scalar
% #3 scalar 2, the end scalar
...
% Example: \textbackslash minScalarResult \(\xrightarrow{} 2\)
% #1 out, var name to save the result (scalar) to
% #2 scalar 1, the first scalar
% #3 scalar 2, the second scalar
...
% Example: \textbackslash maxScalarResult \(\xrightarrow{} 3\)
% Example: \textbackslash maxScalar[resultName]\{\textbackslash myNewScalarA\}\{\textbackslash myNewScalarB\}
% Example: \textbackslash resultName \(\xrightarrow{} 3\)
% #1 out, var name to save the result (scalar) to
% #2 scalar 1, first scalar value
% #3 scalar 2, second scalar value
...
% Example: \textbackslash betweenScalarResult \(\xrightarrow{} 1\)
% #1 out, var name to save the result (scalar) to (0 or 1)
% #2 scalar 1, the scalar to test
