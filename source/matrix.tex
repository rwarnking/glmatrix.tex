...
\newcommand\transposeMat[2][transposeMatResult]{%
    ...
    \xintFor* ##1 in \widthSequence \do {%
        \xintFor* ##2 in \heightSequence \do {%
            \FPset\value{\xintNthElt{##1}{\xintNthElt{##2}{#2}}}
            \xintifForFirst{%
                \newVec{rowVec}{\value}
            }{%
...
\newcommand\addMat[3][addMatResult]{%
    ...
    \xintFor* ##2 in \heightsequence \do {%
        \xintFor* ##3 in \widthsequence \do {%
            \FPset\value{\xintNthElt{##3}{\xintNthElt{##2}{#2}}}
            \xintifForFirst{%
...
\newcommand\subMat[3][subMatResult]{%
    ...
    \xintFor* ##2 in \heightsequence \do {%
        \xintFor* ##3 in \widthsequence \do {%
            ...
            \xintifForFirst{%
                \xintFor* ##1 in \matlist \do {%
                    \FPsub\value\value{\xintNthElt{##3}{\xintNthElt{##2}{##1}}}
                }
                \newVec{rowVec}{\value}
            }{%
                \xintFor* ##1 in \matlist \do {%
...
\newcommand\getMatTranslation[2][matTranslationResult]{%
    ...
    \xintFor* ##1 in \sequence \do {%
        \FPset\value{\xintNthElt{\matWidthResult}{\xintNthElt{##1}{#2}}}
        \xintifForFirst{%
            \newVec{#1}{\value}
        }{%
            \xintifForLast{}{
                \appendToVec{#1}{\csname #1\endcsname}{\value}
            }
        }
    }
}
