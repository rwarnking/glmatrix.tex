...
% Vector Printing %
%%%%%%%%%%%%%%%%%%%
% Print the values of this vector variable in matrix notation
...
% Vector Modification %
%%%%%%%%%%%%%%%%%%%%%%%
% TODO vectorRoundResult
% #1 number of digits after comma, default is 4
% #2 the vector
% \newcommand\roundVec[2][4]{%
% }
...
% \newcommand\powVec[3][powVecResult]{% {Basename}{input}
% }
...
% \newcommand\arccosVec[2][accosVecResult]{
% }

% Adds two vectors after multiplying the second operand by a value
% \newcommand\mulAndAddVec[4][mulAndAddVecResult]{
% }
...
% \newcommand\rotateVec[3][distVecResult] {%
% }

% \newcommand\signedAngleVec[3][distVecResult] {%
% }

% \newcommand\sqrDistVec[3][distVecResult] {%
% }

% \newcommand\sqrLenVec[3][distVecResult] {%
% }

% \newcommand\transformMat2[3][distVecResult] {%
% }

% \newcommand\transformMat2d[3][distVecResult] {%
% }

% \newcommand\transformMat3[3][distVecResult] {%
% }

% \newcommand\transformMat4[3][distVecResult] {%
% }
...
% \newcommand\hermite[3][distVecResult] {%
% }

% \newcommand\rotateX[3][distVecResult] {%
% }

% \newcommand\rotateY[3][distVecResult] {%
% }

% \newcommand\rotateZ[3][distVecResult] {%
% }

% \newcommand\slerp[3][distVecResult] {%
% }
